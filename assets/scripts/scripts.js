class Ghost {
  ...
  setSpriteSheet(name, direction, mode) {
    ...
    if (mode === 'scared') {
      this.animationTarget.style.backgroundImage = 'url(assets/images/'
        + `spriteSheets/characters/ghosts/scared_${this.scaredColor}.png)`;
    } else if (mode === 'eyes') {
      this.animationTarget.style.backgroundImage = 'url(assets/images/'
        + `spriteSheets/characters/ghosts/eyes_${direction}.png)`;
    } else {
      this.animationTarget.style.backgroundImage = 'url(assets/images/'
...
class Pacman {
  constructor(scaledTileSize, mazeArray, characterUtil) {
    ...
    this.reset();
    this.pacmanArrow.style.backgroundImage = ''; // No muestra las <- flechas -> de dirección
  }
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage = 'url(assets/images/'
      + 'spriteSheets/characters/pacman/pacman_death.png)';
    this.animationTarget.style.backgroundPosition = '0px 0px';
...
class GameCoordinator {
  constructor() {
    ...
    //this.gameStartButton.addEventListener('click', this.startButtonClick.bind(this)); // Se elimina el listener del botón de inicio
    ...
    // Añadir los listeners para click y keydown
  ...
  /**
   * Añade listeners para iniciar el juego con click o cualquier tecla
   */
  addStartListeners() {
      // Usamos una variable para asegurarnos de que los listeners se añaden solo una vez
      this.startListenersAdded = true;

      this.startClickHandler = this.startGame.bind(this);
      this.startKeydownHandler = (event) => {
        // Prevenir comportamiento default para teclas como Espacio o Flechas que pueden hacer scroll
        event.preventDefault();
        this.startGame();
      };

      window.addEventListener('click', this.startClickHandler);
      window.addEventListener('keydown', this.startKeydownHandler);
  }

  /**
   * Elimina los listeners de inicio de juego
   */
  removeStartListeners() {
    window.removeEventListener('click', this.startClickHandler);
    window.removeEventListener('keydown', this.startKeydownHandler);
  }

  /**
   * Revela el juego y comienza la partida
   */
  startGame() {
    if (!this.gameStarted) {
      this.gameStarted = true; // Asegurarse de que el juego se inicie solo una vez
      ...
      // Eliminar los listeners después de iniciar el juego
      this.removeStartListeners();
    }
  }

  /**
   * Añade listener para el movimiento del mouse
   */
  ...
  /**
   * Maneja el movimiento del mouse y actualiza la dirección de Pacman
   * @param {MouseEvent} event
   */
  handleMouseMove(event) {
    if (this.allowPacmanMovement && this.gameEngine.running) {
      const pacmanRect = this.pacman.animationTarget.getBoundingClientRect();
      const pacmanCenterX = pacmanRect.left + pacmanRect.width / 2;
      const pacmanCenterY = pacmanRect.top + pacmanRect.height / 2;

      const deltaX = event.clientX - pacmanCenterX;
      const deltaY = event.clientY - pacmanCenterY;

      // Zona muerta (ajusta el tamaño según sea necesario)
      const deadZone = this.scaledTileSize;
      if (
      ...
      this.pacman.changeDirection(newDirection, this.allowPacmanMovement);
    }
  }
  ...
  preloadAssets() {
    return new Promise((resolve) => {
      ...
      const imgBase = 'assets/images/spriteSheets/';
      const imgSources = [
        // Pacman
        //`${imgBase}characters/pacman/arrow_down.png`,
        //`${imgBase}characters/pacman/arrow_left.png`,
        //`${imgBase}characters/pacman/arrow_right.png`,
        //`${imgBase}characters/pacman/arrow_up.png`,
        `${imgBase}characters/pacman/pacman_death.png`,
        `${imgBase}characters/pacman/pacman_error.png`,
        `${imgBase}characters/pacman/pacman_down.png`,
        `${imgBase}characters/pacman/pacman_left.png`,
        `${imgBase}characters/pacman/pacman_right.png`,
        `${imgBase}characters/pacman/pacman_up.png`,

        // Blinky
        `${imgBase}characters/ghosts/blinky/blinky_down_angry.png`,
        `${imgBase}characters/ghosts/blinky/blinky_down_annoyed.png`,
        `${imgBase}characters/ghosts/blinky/blinky_down.png`,
        `${imgBase}characters/ghosts/blinky/blinky_left_angry.png`,
        `${imgBase}characters/ghosts/blinky/blinky_left_annoyed.png`,
        `${imgBase}characters/ghosts/blinky/blinky_left.png`,
        `${imgBase}characters/ghosts/blinky/blinky_right_angry.png`,
        `${imgBase}characters/ghosts/blinky/blinky_right_annoyed.png`,
        `${imgBase}characters/ghosts/blinky/blinky_right.png`,
        `${imgBase}characters/ghosts/blinky/blinky_up_angry.png`,
        `${imgBase}characters/ghosts/blinky/blinky_up_annoyed.png`,
        `${imgBase}characters/ghosts/blinky/blinky_up.png`,

        // Clyde
        `${imgBase}characters/ghosts/clyde/clyde_down.png`,
        `${imgBase}characters/ghosts/clyde/clyde_left.png`,
        `${imgBase}characters/ghosts/clyde/clyde_right.png`,
        `${imgBase}characters/ghosts/clyde/clyde_up.png`,

        // Inky
        `${imgBase}characters/ghosts/inky/inky_down.png`,
        `${imgBase}characters/ghosts/inky/inky_left.png`,
        `${imgBase}characters/ghosts/inky/inky_right.png`,
        `${imgBase}characters/ghosts/inky/inky_up.png`,

        // Pinky
        `${imgBase}characters/ghosts/pinky/pinky_down.png`,
        `${imgBase}characters/ghosts/pinky/pinky_left.png`,
        `${imgBase}characters/ghosts/pinky/pinky_right.png`,
        `${imgBase}characters/ghosts/pinky/pinky_up.png`,

        // Ghosts Common
        `${imgBase}characters/ghosts/eyes_down.png`,
        `${imgBase}characters/ghosts/eyes_left.png`,
        `${imgBase}characters/ghosts/eyes_right.png`,
        `${imgBase}characters/ghosts/eyes_up.png`,
        `${imgBase}characters/ghosts/scared_blue.png`,
        `${imgBase}characters/ghosts/scared_white.png`,

        // Dots
        `${imgBase}pickups/pacdot.png`,
        `${imgBase}pickups/powerPellet.png`,

        // Fruit
        `${imgBase}pickups/apple.png`,
        `${imgBase}pickups/bell.png`,
        `${imgBase}pickups/cherry.png`,
        `${imgBase}pickups/galaxian.png`,
        `${imgBase}pickups/key.png`,
        `${imgBase}pickups/melon.png`,
        `${imgBase}pickups/orange.png`,
        `${imgBase}pickups/strawberry.png`,

        // Text
        `${imgBase}text/ready.png`,

        // Points
        `${imgBase}text/100.png`,
        `${imgBase}text/200.png`,
        `${imgBase}text/300.png`,
        `${imgBase}text/400.png`,
        `${imgBase}text/500.png`,
        `${imgBase}text/700.png`,
        `${imgBase}text/800.png`,
        `${imgBase}text/1000.png`,
        `${imgBase}text/1600.png`,
        `${imgBase}text/2000.png`,
        `${imgBase}text/3000.png`,
        `${imgBase}text/5000.png`,

        // Maze
        'assets/images/maze/maze_blue.png',

        // Misc
        'assets/images/extra_life.png',
      ];

      const audioBase = 'assets/sounds/';
      const audioSources = [
  ...
  startGameplay(initialStart) {
    ...
    // Reproducir el sonido tanto al inicio del juego como al reiniciar el nivel
    ...
    //  Duración para la reproducción del sonido y el texto 'ready'
    const duration = initialStart ? 4500 : 4500; 
    // Retraso adicional para el movimiento de Pac-Man solo al reiniciar el nivel
    const additionalDelay = initialStart ? 0 : 0;
    ...
    new Timer(() => {
      ...
      this.releaseGhost();
    }, duration + additionalDelay); // Sumamos el retraso adicional
  }
  ...
  updateExtraLivesDisplay() {
    ...
    for (let i = 0; i < this.lives; i += 1) {
      ...
      extraLifePic.setAttribute('src', 'assets/images/extra_life.png');
   ...
   */
  handleKeyDown(e) {
    if (e.keyCode === 80) { // <-- Cambia 27 (Esc) a 80 (P)
      // ESC key
      this.handlePauseKey();
  ...
  deathSequence() {
    ...
    // Detener el bucle del sonido power_up
    this.soundManager.stopLoop();

    // Deshabilitar el movimiento con el MOUSE y el teclado (SOLUCIÓN!!!)
    this.allowPacmanMovement = false;
    ...
    // Detener el movimiento de Pacman
    this.allowPacmanMovement = false;
    ...
    new Timer(() => {
      ...
      new Timer(() => {
        ...
        setTimeout(() => {
          ...
          // Reiniciar el flag para permitir que se añadan los listeners de nuevo
          this.gameStarted = false;
          // Volver a añadir los listeners para el nuevo juego
          this.addStartListeners();
  ...
  dotEaten() {
    ...
    if (this.remainingDots === 0) {
      ...
      // Detener el bucle del sonido power_up INMEDIATAMENTE
      this.soundManager.stopLoop();
  ...
  advanceLevel() {
    ...
    const imgBase = 'assets/images/maze/';
    ...
    new Timer(() => {
      ...
      this.mazeImg.src = `${imgBase}maze_white.png`;
      new Timer(() => {
        this.mazeImg.src = `${imgBase}maze_blue.png`;
        new Timer(() => {
          this.mazeImg.src = `${imgBase}maze_white.png`;
          new Timer(() => {
            this.mazeImg.src = `${imgBase}maze_blue.png`;
  ...
  powerUp() {
    ...
    // Iniciar el bucle del sonido power_up
    this.soundManager.loopSound('power_up');
  ...
  displayText(position, amount, duration, width, height) {
    ...
    pointsDiv.style.backgroundImage = 'url(assets/images/'
...
class Pickup {
  ...
  determineImage(type, points) {
    ...
    return `url(assets/images/spriteSheets/pickups/${image}.png)`;
  }
...
class SoundManager {
  ...
  loopSound(sound) {
    // Detener cualquier sonido en bucle anterior
    this.stopLoop(); 

    this.loopPlayer = new Audio(`${this.baseUrl}${sound}.${this.fileFormat}`);
    this.loopPlayer.volume = this.masterVolume;
  ...
  stopLoop() {
    if (this.loopPlayer) {
      ...
      this.loopPlayer.currentTime = 0; // Reiniciar el audio al principio
      this.loopPlayer = null; // Liberar el recurso
    }
  }
